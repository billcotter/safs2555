...
const getTagData = (slug: string) => {
  ...
  const tags = {
    events: {
      title: 'Events',
      description:
        'Latest news and updates about cinema events, festivals, and special screenings.',
      articles: [
        {
          ...
          excerpt:
            'We are thrilled to announce the opening of our new cinema location in downtown...',
        ...
        },
        {
          ...
          excerpt:
            'Mark your calendars for our annual Classic Film Festival...',
        ...
        },
        {
          ...
          excerpt:
            'Join us for a special screening series of classic film noir masterpieces...',
    ...
    'classic-films': {
      title: 'Classic Films',
      description:
        'News and articles about classic films, restoration projects, and film history.',
      articles: [
        {
          ...
          excerpt:
            'Our team has completed the restoration of several classic films from the 1950s...',
    ...
    community: {
      title: 'Community',
      description:
        'Updates about our community programs, educational initiatives, and local partnerships.',
      articles: [
        {
          ...
          excerpt:
            "We're excited to announce our new community outreach program...",
    ...
    technology: {
      title: 'Technology',
      description:
        'Latest developments in film technology, restoration techniques, and cinema equipment.',
      articles: [
        {
          title: 'Major Film Restoration Project Completed',
          category: 'NEWS',
...
export async function generateStaticParams() {
  const slugs = ['events', 'classic-films', 'community', 'technology'];
